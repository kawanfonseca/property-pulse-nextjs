...
const MessageCard = ({ message }) => {
  ...
  return <div className="relative bg-white p-4 rounded-md shadow-md border-gray-200">
    {!isRead && (
      <div className='absolute top-2 right-2 bg-yellow-500 text-white py-1 px-2 rounded-md'></div>
    )}
